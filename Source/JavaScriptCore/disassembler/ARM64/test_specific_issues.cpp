...
int main() {
    ...
    // 3. MLA vs FMLAL conflict
    printf("\n3. MLA vs FMLAL conflict:\n");
    uint32_t mla_h = 0x0f420000; // size=01, Rm=2, Q=0
    uint32_t mla_s = 0x0f820000; // size=10, Rm=2, Q=0
    ...
    if (entry) {
        ...
        printf("   0x%08x (size=10): %s (should be MLA, not FMLAL)\n", mla_s, buffer);
    }
