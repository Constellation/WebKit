#!/usr/bin/env python3
"""
Test lowercase mnemonics and conditional branch formatting
"""
...
# Test cases to verify lowercase and b.ne format
TEST_CASES = [
    # Conditional branches - should be "b.cond" not "B.       cond"
    ...
    # Regular branches - should be lowercase
...
def generate_test_cpp():
    ...
    for opcode, mnemonic, desc in TEST_CASES:
        cpp += f'        {{ 0x{opcode:08x}, "{mnemonic}", "{desc}" }},\n'
...
def main():
    ...
    print("Generating lowercase/conditional format test...")
    test_cpp = generate_test_cpp()

    test_file = os.path.join(output_dir, 'test_lowercase.cpp')
    ...
    print("Testing:")
    print("  - Mnemonics in lowercase (was UPPERCASE)")
    print("  - Conditional branches as 'b.ne' (was 'B.       ne')")
