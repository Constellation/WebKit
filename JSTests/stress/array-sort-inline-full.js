...
// Warm up the DFG compile of sortAsc with a mix of sizes.
for (let w = 0; w < 200; w++)
    for (let n = 0; n <= 16; n++)
        runSize(n);

// Run again to exercise the compiled path.
for (let w = 0; w < 50; w++)
    for (let n = 0; n <= 16; n++)
        runSize(n);
...
for (let i = 0; i < 500; i++) stableTest();
